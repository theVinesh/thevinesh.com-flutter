...
/// Copied from [CupertinoSlidingSegmentedControl]
...
const Color _kSeparatorColor = Color(0xFFFFFFFF);

const Color _kThumbColor = Color(0xFFFFFFFF);
const double _kThumbStrokeWidth = 2.0;
...
/// See also:
///
///  * [SlidingSegmentedControlWithThumbUnderneath], a segmented control widget in the
///    style introduced in iOS 13.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/controls/segmented-controls/>
class SlidingSegmentedControlWithThumbUnderneath<T> extends StatefulWidget {
...
class _SegmentedControlState<T>
    extends State<SlidingSegmentedControlWithThumbUnderneath<T>>
    with
        TickerProviderStateMixin<
            SlidingSegmentedControlWithThumbUnderneath<T>> {
  ...
  void didUpdateWidget(
      SlidingSegmentedControlWithThumbUnderneath<T> oldWidget) {
...
class _RenderSegmentedControl<T> extends RenderBox
  ...
  void _paintThumb(PaintingContext context, Offset offset, Rect thumbRect) {
    ...
    context.canvas.drawRRect(
      ...
      Paint()
        ..color = thumbColor
        ..strokeWidth = _kThumbStrokeWidth
